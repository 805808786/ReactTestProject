    ...
    <section className="card">
      <div className="card-header">
        ...
        <div className="card-header-right">
          ...
          <span className="calendar-tag">日历视图</span>
        </div>
      </div>
          ...
          <div className="change-header">
            ...
            <div className="action-button">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                <path d="M14.6666 4.66666L8.99992 10.3333L5.66659 6.99999L1.33325 11.3333" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M10.6667 4.66666H14.6667V8.66666" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
              <span>查看详细变化</span>
